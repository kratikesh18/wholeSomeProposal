...
const pleaseData = {
  ...
  askingTexts: [
    ...
    "Kya itne bure hu main Daddy..?",
    "Please dil ki baat bol do sweetheart.",
    "Par main toh bohot pyar karti hu na tumse.. sweetheart 😖.",
    "Aap mera dil tod rahe ho Babu..",
    "Aap thode badmash ho kya sweetheart?",
    "Par main toh apni kundali bhi milali hain...",
    "Main tumhe apne raja ki tarah rakhungi... maan jao.",
